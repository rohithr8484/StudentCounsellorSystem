...
<div class="container">
  <center><h2>NSSR</h2></center>

  <center>
  <ul class="nav nav-tabs">
    
    <li class="active"><a data-toggle="tab" href="#home">Internal 1</a></li>
    <li><a data-toggle="tab" href="#menu1">Internal 2</a></li>
    <li><a data-toggle="tab" href="#menu2">Internal 3</a></li>
  ...
  <script>
   $(document).ready(function() {
             ...
             success: function(response){
                 ...
                 console.log(obj);
                $.each(obj, function(){
                var perc = Math.ceil((parseInt(this[3])+parseInt(this[4])*0.6)*2.5); //100/40=2.5
                if(perc<40){
